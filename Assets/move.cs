...
{
    public float moveDistance = 3f; // Distance to move (can be set in the Inspector)
    ...
    void StartMovement()
    {
        ...
        targetPosition = transform.position + new Vector3(0, moveDistance, 0); // Moves along the X-axis
        isMoving = true;
    }
